@extends("layouts.main", ['title' => 'Tracking Status Permintaan Barang'])
@section("content")
					...
					<table id="table-3" class="table table-auto my-3" data-ordering="true" data-paging="true"  data-searching="true">
						<thead class="">
							<tr>
								...
								<th class="text-left">Tanggal Permintaan</th>
						...
						<tbody class="">
							@for ($i = 1; $i <= 4; $i++)
								<tr>
									<td>{{$i}}</td>
									<td>SK.PENGADAAN {{$i}}</td>
									<td>{{$i}}/09/2021</td>
									<td>Kadisnav</td>
									<td>Perbaikan Menara Suar</td>
									<td class="">
										<center>
											<a href="/tracking-status-permintaan/show" class="text-primary hover:text-blue-500 hover:font-semibold underline">
												Lihat Detail
											</a>
										</center>
									</td>
