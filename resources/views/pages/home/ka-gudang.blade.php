@extends("layouts.main", ['title' => 'KEPALA GUDANG - HOME'])
@section("content")
...
<section class="content hidden md:flex flex-col space-y-4 gap-6 px-5 pb-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-7">
        ...
        <div class="col-span-2  space-y-4">
            ...
            <div class="card flex flex-row card-light" x-data="{show: false}">
                ...
                <div class=" w-full">
                    <div class="card-header">
                        <div class="cta-card-head">
                            <h5 class="text-dark cursor-pointer hover:underline" @click="show = !show">Notifikasi</h5>
                        </div>
                    </div>
                    <div class="card-body" x-show="show">
                        <div class="bg-gray-100 p-3 overflow-x-hidden overflow-y-auto max-h-96">
                            @for ($i = 0; $i < 100; $i++)
