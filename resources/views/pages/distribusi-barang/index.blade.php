					...
					<table id="table-3" class="table table-auto my-3" data-ordering="true" data-paging="true"  data-searching="true">
						<thead class="">
							<tr>
								...
								<th class="text-left">Nomor Dokumen</th>
								<th class="text-left">Bidang User</th>
						...
						<tbody class="">
							@for ($i = 1; $i <= 4; $i++)
								<tr>
									@if($i % 2 != 0)
										<td><a href="{{ route('distribusi_barang_detail.simlog', 1) }}">{{$i}}</a></td>
										<td><a href="{{ route('distribusi_barang_detail.simlog', 1) }}">Field</a></td>
										<td><a href="{{ route('distribusi_barang_detail.simlog', 1) }}">Field</a></td>
										<td><a href="{{ route('distribusi_barang_detail.simlog', 1) }}">Field</a></td>
										<td class="">
											<center>
												<button class="btn-sm-success">Diterima</button>
											</center>
										</td>
									@else
										<td><a href="{{ route('distribusi_barang_edit.simlog', 1) }}">{{$i}}</a></td>
										<td><a href="{{ route('distribusi_barang_edit.simlog', 1) }}">Field</a></td>
										<td><a href="{{ route('distribusi_barang_edit.simlog', 1) }}">Field</a></td>
										<td><a href="{{ route('distribusi_barang_edit.simlog', 1) }}">Field</a></td>
										<td class="">
											<center>
												<button class="btn-sm-disabled">Diterima</button>
											</center>
										</td>
									@endif
								</tr>
