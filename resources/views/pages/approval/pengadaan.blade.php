@extends("layouts.main", ['title' => 'Approval Pengadaan Barang'])
@section("content")
						...
						<tbody class="">
							@for ($i = 1; $i <= 4; $i++)
								<tr>
									...
									<td class="">
										<center>
											<a href="/approval-list-pengadaan-barang/validasi-pengadaan" class="text-primary hover:text-blue-500 hover:font-semibold underline">
												Validasi
											</a>
										</center>
									</td>
