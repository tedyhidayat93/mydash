@extends("layouts.main", ['title' => 'Detail Validasi Permintaan Pengadaan'])
@section("content")
            ...
            <form action="" method="GET" class="form-approval flex flex-col gap-5">
                ...
                <div class="flex items-center space-x-10 w-full p-4 bg-gray-200 shadow" x-data="{accept: false}">
                    ...
                    <div class="flex items-center space-x-3 w-5/6">
                        <div class="w-52">
                            {{-- <div class="form-group">
                                <input type="number" min="0" value="100" class="form-control-secondary" :class="{ 'form-control-disabled' : !accept, 'form-control-secondary' : accept}" x-bind:disabled="!accept">
                            </div> --}}
                            <div class="form-group">
