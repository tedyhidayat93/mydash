...
<body class="bg-gray-50 relative" onload="startTime()">

    <a href="/home" class="btn-secondary block md:hidden cursor-pointer p-1 w-10 h-10 rounded-lg flex items-center justify-center absolute bottom-10 right-10 z-30">
        ...
        <div class="hidden md:flex items-center justify-between space-x-2 px-5 w-1/6 h-full border-r-2 border-gray-100">
            <div class="flex items-center space-x-3">
                ...
                <button type="button" class="focus:outline-none full-screen"  onclick="toggleFullScreen()">
                    <svg id="iconshow" xmlns="http://www.w3.org/2000/svg" class="block h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="cards-infographic flex flex-col gap-4 px-3 md:px-6 py-3">
        ...
        <div class="sec-2 flex flex-col md:flex-row items-center gap-5">
            <div class="w-full md:w-1/5 flex flex-col gap-3">
                <div class="card flex items-center h-48 ring-1 ring-inset ring-indigo-400">
