@extends("layouts.main", ['title' => 'Dashboard V3'])
@section("content")
    ...
    <div class="flex gap-7">
        ...
        <div class="w-full" x-data="{ open: true, show:true }">
            <div class="card card-light" x-show="open">
                <div class="card-header">
                    <div class="title-card-head text-dark"><h3> Status Permintaan Barang</h3></div>
                    <div class="cta-card-head">
                ...
                <div class="card-body" x-show="show">
                    <div class="p-5 flex flex-col gap-10 w-full overflow-y-auto overflow-x-hidden" style="max-height: 70vh;">
                        <div class=" p-3 overflow-x-hidden overflow-y-auto max-h-2xl">
                        @for ($i = 0; $i < 200; $i++)
                        <div class="tabulator-tracking flex p-5 hover:bg-gray-200 flex-col space-y-4 mb-10">
                            <div class="">
